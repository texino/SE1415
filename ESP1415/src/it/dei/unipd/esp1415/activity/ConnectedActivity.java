...
public class ConnectedActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		b2.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v) {
					Intent i=new Intent(ConnectedActivity.this,SecondAcitivity.class);
					i.putExtra(SecondAcitivity.ID_TAG,info.getId());
					i.putExtra(SecondAcitivity.NAME_TAG,info.getName());
					i.putExtra(SecondAcitivity.DURATION_TAG,info.getDuration());
					i.putExtra(SecondAcitivity.DATE_TAG,info.getDate());
