...
public class NewPlayButtonDrawable extends Drawable {
	 ...
	 */
	public NewPlayButtonDrawable(Context context,boolean play) {
	 ...
	 * @param context
	 */
	public NewPlayButtonDrawable(Context context) {
		symbolPaint.setAntiAlias(true);
		symbolPaint.setStyle(Paint.Style.FILL);
		symbolPaint.setColor(Color.WHITE);
		circlePaint.setAntiAlias(true);
	...
	/**
	 * @return True se l'attuale simbolo è play
	 */
